const qe = () => {
    let QEDITOR_ALLOW_TAGS_ON_PASTE, QEDITOR_DISABLE_ATTRIBUTES_ON_PASTE, QEDITOR_TOOLBAR_HTML;
    ...
    window.QEditor = {
        ...
        checkSectionState: function(editor) {
            let a, link, _i, _len, _ref, _results;
    ...
    (function($) {
        return $.fn.qeditor = function() {
            return this.each(function() {
                let currentVal, editor, obj, placeholder, qe_heading, toolbar;
                obj = $(this);
